...
public class TodayAppoinment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("Today's Appoinment");

        norecord=findViewById(R.id.norecord);
        recyclerview=findViewById(R.id.recyclerview);

        GridLayoutManager mLayoutManager = new GridLayoutManager(TodayAppoinment.this, 1);
        recyclerview.setLayoutManager(mLayoutManager);
        bookingAdapter = new BookingAdapter(TodayAppoinment.this, bookingModels, R.layout.item_appoinment);
    ...
    private void GetData() {
        ...
        CallJson jc = new CallJson(TodayAppoinment.this);
        param.add(new NetParam("doctor_id",doctorModel.getDoctors_id()));
        jc.SendRequest(s,"get_today_appoinment", param, new JsonCallbacks() {
            @Override
